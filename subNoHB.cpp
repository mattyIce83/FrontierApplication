...
//		deserialized.PrintDebugString();
		...
		for (int i = 0; i < deserialized.slot_data_size(); i++)
		{
			...
			cout << "       lower is_undertemp: " << thisSlot->mutable_heater_location_lower()->is_undertemp() << "\n";
			cout << "        lower is_overtemp: " << thisSlot->mutable_heater_location_lower()->is_overtemp() << "\n";
			cout << "         lower is_enabled: " << thisSlot->mutable_heater_location_lower()->is_enabled() << "\n";
			...
			cout << "       upper is_undertemp: " << thisSlot->mutable_heater_location_upper()->is_undertemp() << "\n";
			cout << "        upper is_overtemp: " << thisSlot->mutable_heater_location_upper()->is_overtemp() << "\n";
			cout << "         upper is_enabled: " << thisSlot->mutable_heater_location_upper()->is_enabled() << "\n";
...
int main(int argc, char *argv[])
{
	...
	{
		printf("Usage: subNoHB <controllerIPAddress>\n");
		exit(-1);
	}
    context = zmq_ctx_new();
#if(0)
